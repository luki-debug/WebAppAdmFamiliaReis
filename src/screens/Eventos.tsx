...
const servicos = [
  ["Bar de Drinks", "Pista Paris"],
  ["Bar de Drinks", "Plataforma 360", "Guarda Chuves decorados", "Love"],
  ["Arco de Flores"],
];
const tarefasExtras = [
  ["Escolher maquiador"],
  ["Escolher vestido", "Contratar Bar"],
  [""],
];
...
function gerarMock(qtd: number): Eventos[] {
  ...
  for (let i = 0; i < qtd; i++) {
    mocks.push({
      ...
      tarefasExtras:
        tarefasExtras[Math.floor(Math.random() * tarefasExtras.length)],
    });
  }
        ...
        <TableBody>
          {mockEventos.map((item, index) => (
            ...
            >
              ...
              <TableCell className="text-center">
                <Button variant="outline" onClick={() => handleDetalhes(item)}>
                  Detalhes
                </Button>
              </TableCell>
            </TableRow>
              ...
              <div className="py-8">
                ...
                <div className="pb-3">
                  <div className="flex justify-between items-center">
                    ...
                    <Badge
                      className={`rounded ${
                        statusColor[itemSelecionado.status] ??
                ...
                <div className="grid grid-cols-2 gap-4 pt-8">
                  <div>
                    ...
                    <p className="text-base">
                      {formatDate(itemSelecionado.dataContrato)}
                    </p>
                  </div>
                  <div>
                    <p className="text-xs text-muted-foreground">
                    ...
                    <p className="text-base">
                      {formatDate(itemSelecionado.dataEvento)}
                    </p>
                    <p className="text-xs text-muted-foreground">
                      Horário: {itemSelecionado.hora}
                    </p>
                  </div>
                </div>
              </div>
